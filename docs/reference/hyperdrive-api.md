---
title: Hyperdrive API Reference
summary: Secure, real-time distributed filesystem API for managing directory trees on Hypercore storage.
tags: [hyperdrive, filesystem, reference]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Hyperdrive filesystem API layered on Hypercore, including mounts and replication.
> - **Primary APIs:** `new Hyperdrive()`, `drive.put()`, `drive.get()`, `drive.checkout()`, `drive.mirror()`.
> - **Protocols/Feeds:** Backing Hypercore feed, metadata feed, replication via `drive.replicate()`.
> - **Dependencies:** Node.js ≥18, `hyperdrive`, optional `corestore`, `hyperswarm`.
> - **Outputs:** Versioned file trees, metadata snapshots, mirror streams.
> - **Next Hop:** [`../walkthroughs/hyperdrive-sync-walkthrough.md`](../walkthroughs/hyperdrive-sync-walkthrough.md)

> Walkthrough companion: `../walkthroughs/hyperdrive-sync-walkthrough.md`
...
## Next Steps
- Synchronise peers via the [Hyperdrive Sync Walkthrough](../walkthroughs/hyperdrive-sync-walkthrough.md).
- Pair filesystem concepts with [Hyperbee API Reference](hyperbee-api.md) to understand metadata storage.
- Review deployment tips in `../platforms/pear/sharing-pear-application.md` when packaging apps.

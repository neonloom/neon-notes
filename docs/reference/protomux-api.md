---
title: Protomux API Reference
summary: Multiplex structured protocols over framed streams with channel lifecycle and message handlers.
tags: [protomux, networking, reference]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Protomux channel registration, message handling, and multiplexing.
> - **Primary APIs:** `protomux.addChannel()`, `channel.addMessage()`, `channel.open()`, `channel.close()`.
> - **Protocols/Feeds:** Protomux framed channels over Duplex streams, message schemas.
> - **Dependencies:** Node.js ≥18, `protomux`, backing stream (e.g., Hypercore replication).
> - **Outputs:** Multiplexed channels, message handlers, per-channel state.
> - **Next Hop:** [`../walkthroughs/protomux-channel-walkthrough.md`](../walkthroughs/protomux-channel-walkthrough.md)

> Walkthrough companion: `../walkthroughs/protomux-channel-walkthrough.md`
...
## Next Steps
- Walk through channel orchestration in the [Protomux Channel Walkthrough](../walkthroughs/protomux-channel-walkthrough.md).
- Plan message schemas with the [hyperschema API Reference](hyperschema-api.md).
- Combine with [Hyperswarm API Reference](hyperswarm-api.md) when attaching to network sockets.

---
title: compact-encoding API Reference
summary: Covers the codec primitives and helper APIs exposed by compact-encoding for building binary schemas.
tags: [compact-encoding, reference, api]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Binary codec primitives and helpers for building compact encodings.
> - **Primary APIs:** `c.encode()`, `c.decode()`, `c.uint8`, `c.struct()`.
> - **Protocols/Feeds:** Applied to Hypercore/Autobase payloads, replication records.
> - **Dependencies:** Node.js ≥18, `compact-encoding`, optional `b4a`.
> - **Outputs:** Encoding descriptors, encoded buffers, decoded objects.
> - **Next Hop:** [`../walkthroughs/compact-encoding-walkthrough.md`](../walkthroughs/compact-encoding-walkthrough.md)

> Walkthrough companion: `../walkthroughs/compact-encoding-walkthrough.md`
...
## Next Steps
- Follow the [Compact-Encoding Walkthrough](../walkthroughs/compact-encoding-walkthrough.md) for end-to-end usage.
- Keep codec snippets close by in `../templates/doc-template.md` when authoring new schemas.
- Cross-check encoding choices with [Autobase API Reference](autobase-api.md) before wiring logs.

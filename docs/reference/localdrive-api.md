---
title: localdrive API Reference
summary: Local filesystem wrapper that mirrors Hyperdrive semantics for staging and testing.
tags: [localdrive, filesystem, reference]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Local filesystem API mirroring Hyperdrive semantics for staging and testing.
> - **Primary APIs:** `new Localdrive()`, `drive.put()`, `drive.get()`, `drive.readdir()`.
> - **Protocols/Feeds:** Local storage only; emulates Hyperdrive’s API surface.
> - **Dependencies:** Node.js ≥18, `localdrive`.
> - **Outputs:** Local directory mirrors, file metadata, test fixtures.
...
## Next Steps
- Prototype workflows locally before deploying to Hyperdrive with [Hyperdrive API Reference](hyperdrive-api.md).
- Pair with [Pear platform staging guide](../platforms/pear/sharing-pear-application.md) when packaging apps.
- Keep metadata patterns aligned with `../guides/frp-overview.md` for deterministic behaviour.

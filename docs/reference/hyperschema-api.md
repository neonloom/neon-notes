---
title: hyperschema API Reference
summary: Manage append-only schema namespaces and code generation for compact-encoding across multi-version peers.
tags: [hyperschema, schema, reference]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Declarative schema authoring and code generation for compact-encoding.
> - **Primary APIs:** `Hyperschema.from()`, `schema.namespace()`, `ns.register()`, `Hyperschema.toDisk()`.
> - **Protocols/Feeds:** Versioned schema namespaces, generated encoding files, Autobase records.
> - **Dependencies:** Node.js ≥18, `hyperschema`, `compact-encoding`.
> - **Outputs:** `schema.json`, generated codec modules, versioned namespace metadata.
> - **Next Hop:** [`../examples/hyperschema/`](../examples/hyperschema/)
...
## Next Steps
- Generate dispatch layers with the [Hyperdispatch LLM Reference](hyperdispatch-api.md).
- Capture schema review checklists in `../meta/authoring-guide.md`.
- Walk through encoding updates using [Compact-Encoding Walkthrough](../walkthroughs/compact-encoding-walkthrough.md).

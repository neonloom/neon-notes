---
title: Hyperbee API Reference
summary: Details the sorted key-value operations Hyperbee provides on top of Hypercore, including batching and streaming reads.
tags: [hyperbee, reference, api]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Sorted key-value operations and iteration on Hyperbee.
> - **Primary APIs:** `new Hyperbee()`, `bee.get()`, `bee.put()`, `bee.createReadStream()`.
> - **Protocols/Feeds:** Backed by Hypercore feed, replicates via `bee.feed.replicate()`.
> - **Dependencies:** Node.js ≥18, `hyperbee`, `hypercore`, optional `corestore`.
> - **Outputs:** Ordered KV snapshots, range iterators, transactional batches.
> - **Next Hop:** [`../walkthroughs/hyperbee-state-walkthrough.md`](../walkthroughs/hyperbee-state-walkthrough.md)

> Walkthrough companion: `../walkthroughs/hyperbee-state-walkthrough.md`
...
## Next Steps
- Practice state projections with the [Hyperbee State Walkthrough](../walkthroughs/hyperbee-state-walkthrough.md).
- Combine Hyperbee with [Autobase API Reference](autobase-api.md) to build record views.
- Review encoding choices in [compact-encoding API Reference](compact-encoding-api.md) before defining schemas.

---
title: Hypercore API Reference
summary: Documents the Hypercore append-only log API, options, and operational guidance for distributed data streams.
tags: [hypercore, reference, api]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Hypercore append-only log API, options, and replication controls.
> - **Primary APIs:** `new Hypercore()`, `core.append()`, `core.get()`, `core.replicate()`.
> - **Protocols/Feeds:** Hypercore wire protocol over noise streams, discovery via Hyperswarm topics.
> - **Dependencies:** Node.js ≥18, `hypercore`, optional `corestore`, `hyperswarm`.
> - **Outputs:** Append-only feeds, proofs, replication streams.
> - **Next Hop:** [`../walkthroughs/hypercore-log-walkthrough.md`](../walkthroughs/hypercore-log-walkthrough.md)

> Walkthrough companion: `../walkthroughs/hypercore-log-walkthrough.md`
...
## Next Steps
- Practice replication loops with the [Hypercore Log Walkthrough](../walkthroughs/hypercore-log-walkthrough.md).
- Review cryptography specifics alongside the [Hypercore Crypto API Reference](hypercore-crypto-api.md).
- Share stream planning context with the [Hyper FRP Integration Guide](../guides/frp-overview.md).

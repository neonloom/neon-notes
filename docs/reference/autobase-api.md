---
title: Autobase API Reference
summary: API surface and operational guidance for Autobase multiwriter logs, including lifecycle hooks and host controls.
tags: [autobase, reference, api]
updated: 2025-11-20
audience: both
---
...
> **Context Card**
> - **Scope:** Autobase constructors, lifecycle hooks, and view management for multiwriter logs.
> - **Primary APIs:** `new Autobase()`, `autobase.open()`, `autobase.ready()`, `autobase.update()`.
> - **Protocols/Feeds:** Writer Hypercores, view Hypercore/Hyperbee, replication streams via `autobase.replicate()`.
> - **Dependencies:** Node.js ≥18, `autobase`, `hypercore`, `corestore`, optional `hyperbee`.
> - **Outputs:** Ordered application views, replication streams, writer metadata.
> - **Next Hop:** [`../walkthroughs/autobase-feed-walkthrough.md`](../walkthroughs/autobase-feed-walkthrough.md), [`fast-forward.md`](fast-forward.md)

> Walkthrough companion: `../walkthroughs/autobase-feed-walkthrough.md`
...
The `fastForward` option and related host semantics are detailed in [`fast-forward.md`](fast-forward.md); reference it when tuning catch-up behavior or aligning indexers.
...
## Next Steps
- Practice the ordering model with the [Autobase Feed Walkthrough](../walkthroughs/autobase-feed-walkthrough.md).
- Align team workflows using [Autobase FRP Playbook](../guides/autobase-frp-playbook.md).
- Pair this reference with [Corestore API](corestore-api.md) when wiring namespaces.

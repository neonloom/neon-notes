---
title: Dagify Quickstart
summary: Install Dagify, create first nodes, and wire FRP helpers with effects kept at the edge.
tags: [dagify, quickstart]
updated: 2025-11-21
audience: both
---
...
Get Dagify installed, create your first nodes, and plug into FRP helpers. Subscriptions shown here are **application-edge only**; keep libraries pure and follow the Agent Directive.
...
## Next steps
- Concepts: `dependency-shapes`, `unbatched`, `shallow-vs-deep`, `types-vs-encodings`, `no-emit`.
- How-to: RxJS/Svelte interop, diff operator, activity thresholding, side-effect patterns.
- Reference: command/bridge/filter/sink/trigger/event nodes and encoding/type helpers.
- Guides: migration notes and Dagify vs RxJS positioning.
- Practices: best practices plus observability/debugging for modeling, reliability, and debugging tips.

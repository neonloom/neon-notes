---
title: Pear CLI Reference
summary: Reference for the pear command-line interface covering project scaffolding, staging, seeding, and runtime flags.
tags: [pear, cli, platform]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Pear CLI commands for scaffolding, developing, building, staging, and seeding apps.
> - **Primary APIs:** `pear init`, `pear dev`, `pear build`, `pear stage`, `pear seed`, runtime flags.
> - **Protocols/Feeds:** Prepares applications to work with Hyper networking and Autobase services.
> - **Dependencies:** Pear CLI, Node.js ≥18, Bare runtime for terminal apps.
> - **Outputs:** Generated projects, running dev servers, packaged bundles, staged deployments.
...
## Next Steps
- Practice staging workflows with [Sharing a Pear Application](sharing-pear-application.md).
- Capture release metadata using [Marking a Pear Release](marking-release.md).
- Troubleshoot commands alongside [Debugging Pear Applications](debugging-pear-app.md).

...
summary: Build a peer-to-peer desktop chat app on Pear, expanding the starter project with UI and replication logic.
tags: [pear, desktop, tutorial]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Extend the Pear desktop starter into a P2P chat application.
> - **Primary APIs:** `pear dev`, Pear runtime APIs (`peer`, `application` modules), Hyper integrations as needed.
> - **Protocols/Feeds:** Expected to wire Autobase/Hyperbee for state sync, Protomux for messaging.
> - **Dependencies:** Pear CLI, Bare runtime, UI stack (HTML/CSS/JS), optional Hyper modules.
> - **Outputs:** Functional desktop chat app, replication hooks, UI components.
...
It continues where [Starting a Pear Desktop Project](starting-desktop-application.md) left off.
...
<div align="center"><img src="https://1301247912-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fjdab83NqbLtX0WX9qY2n%2Fuploads%2Fgit-blob-2b3a10c2398243b52b97b07f7a54fd081cb5f2d7%2Fchat-app-4a.png?alt=media" alt="The first app, with the topic"></div>

Paste the topic into the second app, then click on `Join`.

<div align="center"><img src="https://1301247912-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fjdab83NqbLtX0WX9qY2n%2Fuploads%2Fgit-blob-69aa53b80677ca3f5301e1d980307c15532d7bd8%2Fchat-app-4b.png?alt=media" alt="Second app, using topic from the first"></div>

Once connected, messages can be sent between each chat application.

<div align="center"><img src="https://1301247912-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fjdab83NqbLtX0WX9qY2n%2Fuploads%2Fgit-blob-86df3d7a63aa301385b0e34d487174aa9ae9e458%2Fchat-app-5a.png?alt=media" alt="View from the first app"> <img src="https://1301247912-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fjdab83NqbLtX0WX9qY2n%2Fuploads%2Fgit-blob-e7717afc719cb7c8a64b0becd4fc6e5b47ba8e72%2Fchat-app-5b.png?alt=media" alt="View from the second app"></div>
...
One option is to copy the code, but it is also possible to distribute the application itself over the DHT. This is the topic of [Sharing a Pear Application](sharing-pear-application.md).
...
## Next Steps
- Continue with [Starting a Pear Terminal Project](starting-pear-terminal-app.md) to build CLI companions.
- Stage and distribute builds via [Sharing a Pear Application](sharing-pear-application.md).
- Review deployment tips in [Pear Application Best Practices](best-practices.md).

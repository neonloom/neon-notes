---
title: Pear Migration FAQ
summary: Guidance for upgrading Pear v1 applications to v2, including entrypoint shifts and config changes.
tags: [pear, migration, platform]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Answer migration questions when upgrading Pear v1 apps to v2.
> - **Primary APIs:** Entry point changes (`index.html` → JS), updated Pear config fields, CLI flags.
> - **Protocols/Feeds:** Ensure Hyper integrations continue working post-migration.
> - **Dependencies:** Pear CLI v2, updated runtime, project source requiring migration.
> - **Outputs:** Migration plan, updated entrypoints/config, resolved compatibility notes.
> - **Next Hop:** [`best-practices.md`](best-practices.md)
...
## Next Steps
- Align configuration updates with [Pear Application Configuration](app-config-and-package-json.md).
- Validate staging outputs following [Sharing a Pear Application](sharing-pear-application.md).
- Document migration timelines in team-specific runbooks via `../meta/authoring-guide.md`.

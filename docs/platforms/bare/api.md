---
title: Bare CLI and API Reference
summary: Command usage and embedding notes for the Bare runtime when building low-level services.
tags: [bare, cli, platform]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Bare CLI usage and embedding API for low-level services.
> - **Primary APIs:** `bare <script>`, `bare --runtime`, embedding via `require('bare-*')` shims.
> - **Protocols/Feeds:** Compatible with Hyper libraries through Node module adapters.
> - **Dependencies:** Bare runtime, optional module shims (`bare-stream`, `bare-http`, etc.).
> - **Outputs:** Executable microservices, embedded runtimes, command invocation patterns.
...
## Next Steps
- Review module compatibility in [Bare Modules](bare-modules.md).
- Compare Node.js APIs via [Node.js Compatibility with Bare](node-compatibility.md).
- Plan Pear integrations referencing `../pear/pear-runtime.md`.

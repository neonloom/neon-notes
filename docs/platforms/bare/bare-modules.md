---
title: Bare Modules Compatibility Matrix
summary: Mapping of Node.js core modules to their Bare equivalents and configuration tips.
tags: [bare, modules, compatibility]
updated: 2025-10-18
audience: both
---
...
> **Context Card**
> - **Scope:** Map Node.js core modules to Bare equivalents and installation hints.
> - **Primary APIs:** `npm:bare-node-*` alias packages, import maps, resolver configuration.
> - **Protocols/Feeds:** Ensures Hyper/Autobase services stay portable across Bare and Node.
> - **Dependencies:** Bare runtime, listed shim packages (`bare-fs`, `bare-http`, etc.).
> - **Outputs:** Compatibility matrix, install commands, migration notes.
> - **Next Hop:** [`node-compatibility.md`](node-compatibility.md)
...
## Next Steps
- Review runtime notes in [Bare Runtime Overview](overview.md).
- Compare CLI behaviours via [Bare CLI and API Reference](api.md).
- Capture project-specific module choices in `../pear/pear-runtime.md` when integrating with Pear.
